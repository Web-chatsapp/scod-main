          ...
          .then(async collected => {
                ...
                msg.channel.awaitMessages(m => m.author.id === message.author.id, {
                  ...
                  .then(async collected => {
                    try {
                      ...
                      if (!guild) return message.channel.send("sorry i cant find that guild please make sure i am in there! or DM: `Ashton#1558`");
                      ...
                      console.log(String(e.stack).red)
                      return message.channel.send("sorry i cant find that guild please make sure i am in there! or DM: `Ashton#1558`");
                    }
                  }).catch(e => {
                    console.log(String(e.stack).red)
            ...
            if (collected.first().emoji.name === "2️⃣") {
              try {
                ...
                if (!user) return message.channel.send("sorry i cant find you make sure I am in a guild with you! or DM: `Ashton#1558`");
                databasing(client, "", id)
                ...
                console.log(String(e.stack).red)
                return message.channel.send("sorry i cant find you make sure I am in a guild with you! or DM: `Ashton#1558`");
              }
            }
          }).catch(e => {
            console.log(String(e.stack).red)
