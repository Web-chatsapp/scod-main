...
module.exports = {
    ...
    run: async (client, message, args) => {
        let rules1 = new MessageEmbed()
            ...
            .setThumbnail('https://cdn.discordapp.com/attachments/932598362128130118/932614983542534164/rules.gif')
            .setDescription([`
    ...
    Note: The rules will be changed as per the requirements in the future.`)
            .setImage("https://cdn.discordapp.com/attachments/932598362128130118/932614983542534164/rules.gif")
            .setFooter("Ashton#1295")
