  ...
  try {
    ...
    function reset(track_info_msg, queue_info_msg) {
      let embed2 = new MessageEmbed()
        ...
        .setTitle("Scod | Music Queue")
        .setImage("https://tenor.com/view/listening-to-music-dancing-music-notes-enjoying-gif-14460643.gif")
        .setDescription(`Empty\nJoin a voice channel and queue songs by name or url in here.`)
      let embed3 = new MessageEmbed()
        .setColor(ee.color)
        .setFooter(ee.footertext, ee.footericon)
        .setTitle("Scod | Currently no song is playing!")
        .setDescription(`> Join a voice channel and enter a song name or url to play.\n\n • [Support Server](https://dsc.gg/hi-people) •`)
        .setImage("https://tenor.com/view/listening-to-music-dancing-music-notes-enjoying-gif-14460643.gif")
    ...
    function QueueEmbed(client, player) {
      ...
      const embed = new MessageEmbed().setAuthor(`Scod | Music Queue`);
      const multiple = 15;
      const page = 1;
   ...
   embed.setColor(ee.color);
      embed.setImage("https://tenor.com/view/music-head-shake-headphones-milk-and-mocha-bear-nice-music-gif-16984026.gif");
      embed.setFooter(ee.footertext, ee.footericon);
      return embed;
    }
    function format(millis) {
